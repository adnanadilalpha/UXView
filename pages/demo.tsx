          ...
          {completed ? (
            <div className="w-full flex flex-col max-w-[1080px] mx-auto mt-[10vh] overflow-y-auto pb-8 md:pb-12">
              ...
              >
                ...
                <Link
                  href="https://github.com/Tameyer41/UXView"
                  target="_blank"
                            ...
                            >
                              <source
                                src={
                                  selectedInterviewer.name === "John"
                                    ? selected.name === "Behavioral"
                                      ? "https://UXView-public.s3.amazonaws.com/DemoInterviewMale.mp4"
                                      : "https://UXView-public.s3.amazonaws.com/JohnTechnical.mp4"
                                    : selectedInterviewer.name === "Richard"
                                    ? selected.name === "Behavioral"
                                      ? "https://UXView-public.s3.amazonaws.com/RichardBehavioral.mp4"
                                      : "https://UXView-public.s3.amazonaws.com/RichardTechnical.mp4"
                                    : selectedInterviewer.name === "Sarah"
                                    ? selected.name === "Behavioral"
                                      ? "https://UXView-public.s3.amazonaws.com/BehavioralSarah.mp4"
                                      : "https://UXView-public.s3.amazonaws.com/SarahTechnical.mp4"
                                    : selected.name === "Behavioral"
                                    ? "https://UXView-public.s3.amazonaws.com/DemoInterviewMale.mp4"
                                    : "https://UXView-public.s3.amazonaws.com/JohnTechnical.mp4"
                                }
